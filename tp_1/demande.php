	...
	<body>
		...
		<form action="add_demande.php" method="POST">
			...
			<div>
				...
				<textarea name="commentaire" rows="5" cols="50" maxlength="500" spellcheck required placeholder="commentaire"></textarea>
				<textarea name="nom" rows="1" cols="50" maxlength="500" spellcheck required placeholder="numéro"></textarea>
			</div>
			<div>
				</br>
				<!--boutton d'envoie-->
